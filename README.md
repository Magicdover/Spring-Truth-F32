...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/spring-truth-f32#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/spring-truth-f32
```

A live public deployment of this template is available at [https://spring-truth-f32.templates.workers.dev](https://spring-truth-f32.templates.workers.dev)
